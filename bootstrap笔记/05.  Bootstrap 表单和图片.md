...
<!--
	...
	2.<label class="col-sm-2 control-label">电子邮件</label>  //contral-label:与form中的form-horizontal去同步. 并用后面的栅格系统参数
...
```
注：这里用到了 col-sm 栅格系统，上一章节已重点讲解，而 control-label 表示和父元素样式同步。
